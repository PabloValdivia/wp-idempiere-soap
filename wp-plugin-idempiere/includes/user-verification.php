	 ...
	 //----------------- End get user detail ------------    
		...
		//if($vstring == $userenter)
		{
			...
			{			
				...
				$user_verify='<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:_0="http://idempiere.org/ADInterface/1_0"> <soapenv:Header/> <soapenv:Body>  <_0:createUpdateData> <_0:ModelCRUDRequest> <_0:ModelCRUD>  <_0:serviceType>wp-VerifyUser</_0:serviceType> <_0:DataRow> <_0:field column="AD_User_ID">  <_0:val>'. $uid .'</_0:val> </_0:field> <_0:field column="EMailVerifyDate"> <_0:val>'. $dat .'</_0:val>  </_0:field><_0:field column="IsLocked"><_0:val>N</_0:val>  </_0:field>  </_0:DataRow>  </_0:ModelCRUD>  '.$login_request.' </_0:ModelCRUDRequest> </_0:createData> </soapenv:Body> </soapenv:Envelope>';
				...
				*/
				...
				if($output!=''){
					echo "<p class'success'>Thank you for verification. Now you can login successfully.  </p>";
					//header('Location: '.site_url().'/user-login');
				}

				/*else
				{
				echo "<p style='color:red; text-align:center'>Please fill valid information</p>";
				}*/
				curl_close($soap_do);
			}
			else
			{
			 echo "<p style='color:red; text-align:center'>Fail Verification</p>";
			}	
		...
		{
			echo "<p style='color:red; text-align:center'>You are not registered</p>";
		}
	/*}*/
	 /*echo $VHTML='<form  id="vemail" name="vemail" action=""  method="POST" >

			    <input type="text" name="verifiedcode" id="vcode" placeholder="Please enter verification Code" value="" required="required" ><br>

				<input type="email" placeholder="Please enter your email"  name="username_verify" id="username_verify" required="required" value="" ><br/>

				<input type="submit" name="verify" value="Please Verify"  />
			</form>';*/
}
?>
